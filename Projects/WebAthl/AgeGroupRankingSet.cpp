// AgeGroupRankingSet.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CAgeGroupRankingSet, CRecordsetEx)

CAgeGroupRankingSet::CAgeGroupRankingSet(CDatabase* pdb)
	: CRecordsetEx(pdb)
{
	//{{AFX_FIELD_INIT(CAgeGroupRankingSet)
	m_SeriesID = 0;
...
CString CAgeGroupRankingSet::GetDefaultConnect()
{
	return _T("");
}

CString CAgeGroupRankingSet::GetDefaultSQL()
{
	return _T("[Results],[EventType]");
}

void CAgeGroupRankingSet::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CAgeGroupRankingSet)
...
/////////////////////////////////////////////////////////////////////////////
// CAgeGroupRankingSet diagnostics

#ifdef _DEBUG
void CAgeGroupRankingSet::AssertValid() const
{
	CRecordsetEx::AssertValid();
}

void CAgeGroupRankingSet::Dump(CDumpContext& dc) const
{
